...
function MyOrders() {
  ...
  const handleSectionClick = (sections) => {
    setActiveSection(sections[0]); // أو أي منطق آخر لاختيار الحالة الافتراضية
    setSelectedOrderId(null);
    setShowCard(false);
  };
    ...
    >
      ...
      >
        <SectionButton
          ...
          onClick={() =>
            handleSectionClick(["new", "Pending", "Processing", "In-way"])
          }
          labelStyle={{
            fontSize: "1.2rem",
            marginLeft: ".5rem",
            ...
            <CardContent sx={{ p: 0 }}>
              ...
              >
                <Stack direction={"row"} alignItems={"center"}>
                  ...
                  >
                    {orderDetails.items[0].info[0].size_en}
                  </Typography>
                </Stack>
                <Stack
                  direction={"row"}
                ...
                >
                  ...
                  >
                    {orderDetails.items[0].total_price}
                  </Typography>
                </Stack>
              </Stack>
            </CardContent>
